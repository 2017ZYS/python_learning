# -*- coding: utf-8 -*-
"""
Created on Thu Oct 25 09:08:39 2018
...
req=response.read()
#将数据写入文件
with open('btc_close_2017_urllib_json', 'wb') as f:
    f.write(req)
#加载json格式
#file_urllib=json.loads(req.decode('utf-8'))
file_urllib=json.loads(req.decode())
print(file_urllib)
