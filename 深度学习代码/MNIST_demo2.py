# -*- coding: utf-8 -*-
"""
Created on Sat Jul 13 18:38:30 2019

@author: ZYS
"""
#coding=utf-8
#MNIST的AlexNet实现:略微有点不一样的是第一个卷积层和第二个卷积层的卷积核分别是64,192不是论文中的96,256
#结果是训练数据：0.98438%，测试数据0.957
#from __future__ import print_function
 
from tensorflow.examples.tutorials.mnist import input_data
 
mnist = input_data.read_data_sets("C:\\Users\\ZYS\\Desktop\\python_learning\\深度学习代码\\MNIST_data", one_hot=True)
